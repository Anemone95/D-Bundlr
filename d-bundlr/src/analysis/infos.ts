...
export function normalizeModuleName(s: string): string { // TODO: should utilize "main" in package.json (see ModuleInfo.getOfficialName)
...
export class ModuleInfo {
    ...
    getPath(): FilePath {
        ...
        return path.resolve(`${this.packageInfo.dir}${sep}${this.relativePath}`);
    }
...
export class FunctionInfo {
    ...
    readonly freeVarsRead: Set<Identifier> = new Set; // TODO: include JSXIdentifiers?

    readonly freeVarsWrite: Set<Identifier> = new Set;

    freeVarsReadArguments: Function | undefined = undefined; // enclosing non-arrow function if reading 'arguments' in arrow function

    freeVarsReadThis: Function | undefined = undefined;
    ...
    constructor(
        ...
        readonly inTopImmediateFunction: boolean // true if this function is defined in the top immediate function
    ) {}
