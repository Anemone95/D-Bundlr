...
export class FragmentState<RVT extends RepresentativeVar | MergeRepresentativeVar = RepresentativeVar> {
    ...
    registerCallSites(
        ...
        this.callSites.set(node, {baseVar, prop, calleeVar, argVars, caller});
    }
    ...
    *getAllVarsAndTokens(): Iterable<[RVT, Set<Token> | Array<Token>, number]> {
    ...
    addToken(t: Token, v: RVT): boolean {
        if (t.toString()==="Object[@cs-au-dk/jelly@0.10.0:tmp/main.636f2712.js:4:13:6749:10]" && v.toString()==="Object[@cs-au-dk/jelly@0.10.0:tmp/main.636f2712.js:4:13:6749:10].730")
