...
export class GlobalState {
    ...
    outmostFunctions: Set<Function> = new Set();
    ...
    registerFunctionInfo(file: FilePath, path: NodePath<Function>, name: string | undefined) {
        ...
        const m = this.moduleInfosByPath.get(file)!;
        // const f = new FunctionInfo(name, fun.loc!, m, isDummyConstructor(fun), !earlyStop && parent.isProgram());
        const f = new FunctionInfo(name, fun.loc!, m, isDummyConstructor(fun), !inMap && inFunction<=3);
